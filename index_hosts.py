...
def create_documents_from_hostnames(es_client, index_name, hostnames, base_fields):
    ...
    using a base set of fields. The 'client' field is dynamically
    set to the hostname value for each document.
    """
    actions = []
    if not hostnames:
    ...
    for hostname in hostnames:
        ...
        doc_source["client"] = hostname   # Dynamically set client to the hostname
